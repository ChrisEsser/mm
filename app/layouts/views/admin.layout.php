...
<head>
    ...
    <link rel="stylesheet" href="/css/betterButtons.css?ver=113"/>
    <link rel="stylesheet" href="/css/style.css?ver=113"/>

    <script src="https://code.jquery.com/jquery-3.6.0.min.js" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js"></script>
    <script src="/js/confirm.js?ver=113"></script>
    <script src="/js/tableData.js?ver=113"></script>
    <?= HTML::displayHead() ?>
</head>
